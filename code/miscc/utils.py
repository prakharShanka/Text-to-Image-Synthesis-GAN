...
def build_super_images(real_imgs, captions, ixtoword,
    ...
    for i in range(num):
        ...
        if lr_imgs is None:
            ...
            lrI = lr_imgs[i]
        row = [lrI, middle_pad]
        #print("length of lrI",len(lrI))
        #print("length of middle_pad",len(middle_pad))
        #print("length.......",len(row[0]))

        row_merge = [img, middle_pad]
        #print("length of lrI",len(img))
        #print("length of middle_pad",len(middle_pad))
        #print("length.......",len(row_merge[0]))
        row_beforeNorm = []
        ...
        print("onemap length",len(one_map[0]))
        print("middpad length",len(middle_pad[0]))
        print("row after append.................",len(row))
        print("row cols after append.................",len(row[0]))
        print("............")
        print("onemap length",len(merged[0]))
        print("middpad length",len(middle_pad[0]))
        print("row after append.................",len(row_merge))
        print("row cols after append.................",len(row_merge[0]))
